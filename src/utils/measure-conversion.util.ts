 ...
 */
export function convertMeasure(quantity: number, fromMeasure: string, toMeasure: string | null | undefined): number {
 ...
 */
export function parseAmountMeasure(amountMeasure: string): { quantity: number; measure: string } {
    if (!amountMeasure) {
